...
Partial Class mbDeviceLocation
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "You can't put more than one device"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "in the same location."
        '
        'Timer1
        '
        '
        ...
        Me.Name = "mbDeviceLocation"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "mbDeviceLocation"
